    ...
    <>
      ...
      <div className="max-w-screen-xl mx-auto pt-24 px-4 md:px-0">
        <div className="text-center">
          <h2 className="primary-color text-5xl font-bold pb-2 mb-4">
            Choose the right service for you
          </h2>
          <h5 className="text-gray-500 text-base">
            Enter your number of{" "}
            <span className="text-red">your employees </span>* and select the
            most suitable package below.
          </h5>
          <h5 className="text-gray-500 text-base">
            Alternatively, feel free to call us on{" "}
            <span className="text-lightblue font-bold">01455 858 132</span> to
            find out more.
          </h5>
        </div>
          ...
          <div className="flex flex-col w-1/5">
            <div className="relative">
              ...
              <label
                ...
                className="absolute text-xs uppercase color-primary dark:text-gray-400 duration-300 transform -translate-y-6 scale-75 top-3 -z-10 origin-[0] peer-focus:left-0 peer-focus:text-blue-600 peer-focus:dark:text-blue-500 peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-6"
              >
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 py-12">
          ...
          <div className="flex flex-col justify-center">
            <div className="bg-red rounded-t-2xl">
              <h5 className="flex flex-col text-white text-sm uppercase font-bold text-center py-2">
                most popular
              </h5>
            </div>
              ...
              <div className="p-6">
                ...
                <ul className="py-3">
                  ...
                  <li className="flex items-start text-sm py-2">
                    ...
                    <span className="px-2">
                      Health & safety review and confidential compliance report
                    </span>
                  </li>
                  <li className="flex items-start text-sm py-2">
                    <div className="bg-green-500 rounded-xl text-white p-0.5">
      ...
      <div className="w-full bg-neutral-300">
        <div className="max-w-screen-xl mx-auto">
          <div className="py-16 my-8 rounded-2xl">
            ...
            <h5 className="text-green-600 max-w-xl py-2">
