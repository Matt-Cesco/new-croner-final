...
const ModalGetInstantQuoteWhite = () => (
  <Dialog.Root>
    <Dialog.Trigger asChild>
      <button className="w-full text-center font-bold uppercase py-4 px-8 text-white cursor-pointer">
        get instant quote
      </button>
    </Dialog.Trigger>
    <Dialog.Portal>
...
export default ModalGetInstantQuoteWhite;
